...
public class GrpcMethodInvokerConfig {
    ...
    @Bean
    public DiscoveryClientAdapter discoveryClientAdapter(ServiceDiscoveryClient serviceDiscoveryClient) {
        return serviceName -> {
            ...
            return response.instances()
                    ...
                    .orElseThrow(() -> new RuntimeException("Service instance not found in AWS Cloud Map: " + serviceName));
        };
    }
