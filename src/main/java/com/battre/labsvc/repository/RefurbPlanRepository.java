...
public interface RefurbPlanRepository extends JpaRepository<RefurbPlanType, Integer> {
  ...
  @Transactional
  @Modifying
  @Query("UPDATE RefurbPlanType " + "SET available = false " + "WHERE refurbPlanId = :refurbPlanId")
  void markRefurbPlanBusy(@Param("refurbPlanId") int refurbPlanId);

  @Transactional
  @Modifying
  @Query("UPDATE RefurbPlanType " + "SET available = true " + "WHERE refurbPlanId = :refurbPlanId")
  ...
  @Modifying
  @Query(
      "UPDATE RefurbPlanType "
          + "SET refurbPlanEndDate = :refurbPlanEndDate "
          + "WHERE refurbPlanId = :refurbPlanId")
  void endRefurbPlanEntry(
      @Param("refurbPlanId") int refurbPlanId,
  ...
  void setBatteryRefurbPriority(
      @Param("batteryId") int batteryId, @Param("refurbPlanPriority") int refurbPlanPriority);
  ...
  @Query(
      "UPDATE RefurbPlanType "
          ...
          + "WHERE refurbPlanId = :refurbPlanId")
  void setResolderRecord(
      @Param("refurbPlanId") int refurbPlanId, @Param("resolderRecordId") int resolderRecordId);
  ...
  @Query(
      "UPDATE RefurbPlanType "
          ...
          + "WHERE refurbPlanId = :refurbPlanId")
  void setRepackRecord(
      @Param("refurbPlanId") int refurbPlanId, @Param("repackRecordId") int repackRecordId);
  ...
  @Query(
      "UPDATE RefurbPlanType "
          ...
          + "WHERE refurbPlanId = :refurbPlanId")
  void setCapacitorSwapRecord(
      @Param("refurbPlanId") int refurbPlanId,
      @Param("capacitorSwapRecordId") int capacitorSwapRecordId);

  @Query(
      "SELECT refurbPlanId, batteryId, "
          +
          // needResolder
