...
CREATE TABLE IF NOT EXISTS LabSvcSchema.RefurbStations (
  ...
  last_calibration_date TIMESTAMP NOT NULL,
  next_calibration_date TIMESTAMP NOT NULL,
  CONSTRAINT rs_refurb_station_class_id_fk FOREIGN KEY (refurb_station_class_id) REFERENCES LabSvcSchema.RefurbStationClasses(refurb_station_class_id) ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE IF NOT EXISTS LabSvcSchema.RefurbRecords (
  ...
  CONSTRAINT rr_refurb_plan_id_fk FOREIGN KEY (refurb_plan_id) REFERENCES LabSvcSchema.RefurbPlans(refurb_plan_id) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT rr_refurb_stn_id_fk FOREIGN KEY (refurb_stn_id) REFERENCES LabSvcSchema.RefurbStations(refurb_stn_id) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT rr_result_type_id_fk FOREIGN KEY (result_type_id) REFERENCES LabSvcSchema.ResultTypes(result_type_id) ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE IF NOT EXISTS LabSvcSchema.TesterRecords (
  ...
  CONSTRAINT tr_tester_stn_id_fk FOREIGN KEY (tester_stn_id) REFERENCES LabSvcSchema.TesterStations(tester_stn_id) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT tr_test_scheme_id_fk FOREIGN KEY (test_scheme_id) REFERENCES LabSvcSchema.TestSchemes(test_scheme_id) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT tr_refurb_scheme_id_fk FOREIGN KEY (refurb_scheme_id) REFERENCES LabSvcSchema.RefurbSchemes(refurb_scheme_id) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT tr_result_type_id_fk FOREIGN KEY (result_type_id) REFERENCES LabSvcSchema.ResultTypes(result_type_id) ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE IF NOT EXISTS LabSvcSchema.LabPlans (
  ...
  refurb_plan_id INT,
  CONSTRAINT lab_plan_status_id_fk FOREIGN KEY (lab_plan_status_id) REFERENCES LabSvcSchema.LabPlanStatus(lab_plan_status_id) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT tester_record_id_fk FOREIGN KEY (tester_record_id) REFERENCES LabSvcSchema.TesterRecords(tester_record_id) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT refurb_plan_id_fk FOREIGN KEY (refurb_plan_id) REFERENCES LabSvcSchema.RefurbPlans(refurb_plan_id) ON DELETE NO ACTION ON UPDATE NO ACTION
);