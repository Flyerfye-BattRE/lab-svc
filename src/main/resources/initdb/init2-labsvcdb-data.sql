...
INSERT INTO LabSvcDb.TestSchemes (test_scheme_id, checkerboard, null_line, vapor_sim, blackout, oven_screen) VALUES
...
INSERT INTO LabSvcDb.RefurbStationTypes (refurb_station_type_id, station_type) VALUES
(1, 'Soldering'),
(2, 'Repackaging'),
(3, 'Processor Swap'),
(4, 'Capacitor Swap');
...
INSERT INTO LabSvcDb.TesterStations (tester_stn_id, terminal_layout_id, last_calibration_date, next_calibration_date) VALUES
...
INSERT INTO LabSvcDb.RefurbStations (refurb_stn_id, refurb_station_type_id, last_calibration_date, next_calibration_date) VALUES
...
INSERT INTO LabSvcDb.ResultTypes (result_type_id, result_type) VALUES
(1, 'Pass'),
(2, 'Fail'),
(3, 'Exception'),
(4, 'Retry');
...
INSERT INTO LabSvcDb.RefurbActions (refurb_action_id, refurb_action) VALUES
(1, 'Retest'),
(2, 'Next Refurb Step'),
(3, 'Move to Storage'),
(4, 'Destroy');
